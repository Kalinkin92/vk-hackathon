jQuery(document).ready(function() {
    ...
    require(
        ...
        function(ec) {
            ...
            firebase.database().ref('/users/today').once('value').then(
                snap => {
                    let data = snap.val();
                    // console.log(data);
                    data = Object.values(data);
                    // data = data.sort((a,b)=> a.date > b.date);
                    let xAxis = data.reduce((acc, item) => {
                        acc.push(item.date);
                        return acc;
                    }, []);
                    let series = {};
                    series.total = data.reduce((acc, item) => {
                        acc.push(item.total);
                        return acc;
                    }, []);
                    series.new = data.reduce((acc, item) => {
                        acc.push(item.new);
                        return acc;
                    }, []);
                    ...
                    data = {
                        ...
                        legend: {
                            data: [ 'Новые посетители','Посетителей всего',]
                        },
                        toolbox: {
                            show: true,
                            feature: {
                        ...
                        xAxis: [{
                            type: 'category',
                            data: xAxis
                            // data: ['30.10', '31.10', '01.11', '02.11', '03.11', '04.11', '05.11', '06.11', '07.11', '08.11', '09.11', '10.11']
                        ...
                        series: [{
                            name: 'Посетителей всего',
                            type: 'bar',
                            data: series.total
                            // data: [2, 5, 9, 26, 28, 48, 18, 16, 12, 70, 175, 182]
                        }, {
                            name: 'Новые посетители',
                            type: 'bar',
                            data: series.new
                            // data: [2, 4, 7, 14, 16, 20, 2, 6, 3, 24, 75, 90]
                        }]
                    };
